...
class ResnetTrain:
    '''
    Used to train resnet-like models
    '''
    def __init__(self, model, file_name_train, dir_name_train,
                 file_name_val=None, dir_name_val=None, val_percent=5, regression=True, num_workers=4):
        '''
        The constructor for the resnet trainer. Calls build_extender which overrides the last layer of the model.
        :param model: The specified resnet-like model
        ...
        total_dataset_1 = SingleImageDataset(file_name_train, dir_name_train, transform=self.my_transforms['train'], regression=regression) #TODO improve?
    ...
    def build_extender(self, regression):
        ...
        num_ftrs = self.main_model.fc.in_features
    ...
    def feat_extract(self, lr=0.001, epochs=5, top_k=1):
        ...
        '''
        optimizer_ft = torch.optim.Adam(self.main_model.fc.parameters(), lr=lr)
        if self.regression:
